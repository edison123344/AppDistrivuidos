...
a persistence unit "UpsParqueaderoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "UpsParqueadero\pom.xml":
...
artifact ("UpsParqueadero.war") is already built. You can build

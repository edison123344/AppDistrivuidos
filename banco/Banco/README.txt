...
a persistence unit "BancoPracticaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BancoPractica\pom.xml":
...
artifact ("BancoPractica.war") is already built. You can build

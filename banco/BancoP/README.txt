...
a persistence unit "BancoPPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BancoP\pom.xml":
...
artifact ("BancoP.war") is already built. You can build

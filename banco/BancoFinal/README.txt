...
a persistence unit "AnalisisPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Analisis\pom.xml":
...
artifact ("Analisis.war") is already built. You can build

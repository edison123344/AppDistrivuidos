...
a persistence unit "clienteBibliotecaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "clienteBiblioteca\pom.xml":
...
artifact ("clienteBiblioteca.war") is already built. You can build
